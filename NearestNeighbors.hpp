...
namespace Neighborhood {
    ...
    public:
        ...
        NearestNeighbors() : Node("nearest_neighbors") {
            this->declare_parameter<int>("nb_drones",1);
            this->declare_parameter<double>("neighbor_distance",1.0);
            this->declare_parameter<std::vector<double>>("x_init",{0.0});
            this->declare_parameter<std::vector<double>>("y_init",{0.0});
