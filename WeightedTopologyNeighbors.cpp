...
Neighborhood::WeightedTopologyNeighbors::WeightedTopologyNeighbors()
        ...
        this->declare_parameter<std::vector<bool>>("leaders", {false});
        this->declare_parameter<std::vector<double>>("x_formation", {0.0});
        this->declare_parameter<std::vector<double>>("y_formation", {0.0});
        this->declare_parameter<std::vector<double>>("z_formation", {0.0});
